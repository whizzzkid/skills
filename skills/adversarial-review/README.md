...
- **99 mechanical sweeps run unconditionally** before LLM reasoning.
  ...
  across typed sources and static fixtures plus deterministic browser-profile
  parity across sibling harnesses.
