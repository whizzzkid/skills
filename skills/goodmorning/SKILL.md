...
```bash
mkdir -p "$WK_SKILLS_HOME/learnings/skills/goodmorning"
```

Write to
`$WK_SKILLS_HOME/learnings/skills/goodmorning/<YYYY-MM-DD>_<learning-slug>.md`:
...
> "📝 Learning captured: `goodmorning/<date>_<slug>.md` — distill with
