...
```bash
mkdir -p "$WK_SKILLS_HOME/learnings/skills/pr-review"
```

Write to
`$WK_SKILLS_HOME/learnings/skills/pr-review/<YYYY-MM-DD>_<learning-slug>.md`:
...
> "📝 Learning captured: `pr-review/<date>_<slug>.md` — distill with
