...
```bash
mkdir -p "$WK_SKILLS_HOME/learnings/skills/goodevening"
```

Write to
`$WK_SKILLS_HOME/learnings/skills/goodevening/<YYYY-MM-DD>_<learning-slug>.md`:
...
> "📝 Learning captured: `goodevening/<date>_<slug>.md` — distill with
