...
```bash
mkdir -p "$WK_SKILLS_HOME/learnings/skills/datadog"
```

Write to
`$WK_SKILLS_HOME/learnings/skills/datadog/<YYYY-MM-DD>_<learning-slug>.md`:
...
> "📝 Learning captured: `datadog/<date>_<slug>.md` — distill with
