...
- **Why:** Repeated structure/format mistakes (flat bullets, multiple links per line, bare `#NNN`, plain-text-only clipboard) came from callers reinventing the spec; centralizing in wk-slack lets goodmorning/goodevening delegate.
