...
```bash
mkdir -p "$WK_SKILLS_HOME/learnings/skills/retro"
```

Write to
`$WK_SKILLS_HOME/learnings/skills/retro/<YYYY-MM-DD>_<learning-slug>.md`:
...
> "📝 Learning captured: `retro/<date>_<slug>.md` — distill with
