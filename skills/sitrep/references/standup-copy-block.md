...
3. Click `.st-copy-btn`; wait for `Copied ✓`. When clipboard readback is
   available, confirm the plain payload starts with `👈🏽 Yesterday` and contains
   all three headings.
