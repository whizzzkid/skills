...
- **Why:** In the SilverBullet model the user triages by editing the live markdown in the browser — a per-item keep/skip prompt inherited from the former HTML-output evening flow is redundant and gets interrupted.
